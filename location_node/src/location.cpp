...
Location::Location(const std::string& calibrate_path, const std::string& map_config_path) {
    ...
    std::map<std::string, double> region_height = {
        {"Self_Tower", 0.15f}, {"Enemy_Tower", 0.15f}, {"Middle_High", 0.3f},
        {"Self_Left_High", 0.f}, {"Enemy_Left_High", 0.2f},
        {"Self_Ring_High", 0.26f}, {"Enemy_Ring_High", 0.26f}, {"Enemy_Buff", 0.8f}
    };
// {"resource", 0.f},能量单元兑换点
    // 加载标定参数
